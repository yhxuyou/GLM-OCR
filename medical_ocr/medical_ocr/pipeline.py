...
class MedicalOcrPipeline(Pipeline):
    ...
    def _medical_terminology_normalization(
        ...
        Standardizes common medical units and terminology.
        """
        try:
    ...
    def process(
        ...
        Args:
            ...
            save_layout_visualization: Whether to save visualization
            page_maxsize: Page queue max size
            region_maxsize: Region queue max size
        ...
        Yields:
            Processed PipelineResult objects
        """
